...
def precentage_delay():
    ...
    return render_template('percentage.html',origin=(origin_airport),destination=(dest_airport))
...
def percentageofdelay(src,dest,airlinesname):
    ...
    plt.savefig('C:\python programs\django_sample\djangoapp\static\djangoapp\piechart2.jpg')
    return plt
